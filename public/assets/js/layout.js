        ...
        <section class="mega-menu" aria-label="Collections submenu">
            <div class="mega-menu-inner">
                <div class="mega-menu-grid">
                    <a class="mega-menu-card" href="gold-jewellery.html">
                    ...
                    <a class="mega-menu-card" href="diamond-jewellery.html">
                        <div class="mega-menu-card-image">
                    ...
                    <a class="mega-menu-card" href="bridal-sets.html">
                        <div class="mega-menu-card-image">
                    ...
                    <a class="mega-menu-card" href="custom-jewellery.html">
                        <div class="mega-menu-card-image">
            ...
            <nav class="mobile-nav" aria-label="Mobile navigation">
                ...
                <div class="mobile-nav-accordion">
                    ...
                    <ul class="mobile-nav-accordion-list" id="mobile-collections-list" role="region" aria-label="Collections">
                        <li><a href="gold-jewellery.html">Gold Jewellery</a></li>
                        <li><a href="diamond-jewellery.html">Diamond Jewellery</a></li>
                        <li><a href="bridal-sets.html">Bridal Collection</a></li>
                        <li><a href="custom-jewellery.html">Custom Jewellery</a></li>
                    </ul>
                </div>
                <a href="/blog">Blogs</a>
