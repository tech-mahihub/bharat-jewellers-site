...
(function() {
    ...
    const categories = {
        ...
        'bridal-sets': {
            ...
            heroImage: 'https://bharatjewellers.ca/wp-content/uploads/2025/11/Gold-Bridal-Sets.webp',
            highlight: {
        ...
        'custom-jewellery': {
            ...
            heroImage: 'https://bharatjewellers.ca/wp-content/uploads/2025/11/Custom-Jewellery-Surrey-BC.webp',
            highlight: {
    ...
    const categoryKey = params.get('category') || 'gold-jewellery';
    ...
    if (detailsTitle) {
        detailsTitle.textContent = 'Crafted with Pure 22K Excellence';
    }
    if (detailsText) {
