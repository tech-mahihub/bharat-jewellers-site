        ...
        <section class="mega-menu" aria-label="Collections submenu">
            <div class="mega-menu-inner">
                <div class="mega-menu-grid">
                    <a class="mega-menu-card" href="category.html?category=gold-jewellery">
                    ...
                    <a class="mega-menu-card" href="category.html?category=diamond-jewellery">
                        <div class="mega-menu-card-image">
                    ...
                    <a class="mega-menu-card" href="category.html?category=bridal-sets">
                        <div class="mega-menu-card-image">
                    ...
                    <a class="mega-menu-card" href="category.html?category=custom-jewellery">
                        <div class="mega-menu-card-image">
            ...
            <nav class="mobile-nav" aria-label="Mobile navigation">
                ...
                <div class="mobile-nav-accordion">
                    ...
                    <ul class="mobile-nav-accordion-list" id="mobile-collections-list" role="region" aria-label="Collections">
                        <li><a href="category.html?category=gold-jewellery">Gold Jewellery</a></li>
                        <li><a href="category.html?category=diamond-jewellery">Diamond Jewellery</a></li>
                        <li><a href="category.html?category=bridal-sets">Bridal Collection</a></li>
                        <li><a href="category.html?category=custom-jewellery">Custom Jewellery</a></li>
                    </ul>
                </div>
                <a href="/blog">Blogs</a>
      ...
      <div class="footer-bottom">
        ...
        const setActiveNav = () => {
            ...
            links.forEach((link) => {
                ...
                if (pathOnly === 'category.html' && href.indexOf('category=') !== -1) {
                    const pageCat = new URLSearchParams(window.location.search).get('category');
                    const linkCat = (href.split('?')[1] || '').split('&').find(function(p) { return p.startsWith('category='); });
                    const linkCategory = linkCat ? linkCat.replace('category=', '') : '';
                    if (pageCat && linkCategory === pageCat) link.classList.add('active');
                    return;
                }
                if (linkPath === pathOnly) link.classList.add('active');
            });
            const collectionsTrigger = document.querySelector('.nav-link-mega-trigger');
            if (collectionsTrigger && (pathOnly === 'collections.html' || pathOnly === 'category.html')) {
        ...
        // Mega menu: show on hover of Collections or the dropdown; use header class so menu is positioned from header baseline
